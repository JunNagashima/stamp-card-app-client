...
const DailyMissionStampApp: React.FC = () => {
  ...
  const [dailyMissions, setDailyMissions] = useState<Mission[]>([
    ...
    { id: 3, title: "読書 (30分)", completed: false, category: "趣味", icon: <Star className="w-4 h-4 text-purple-500" /> },
    { id: 4, title: "瞑想", completed: true, category: "健康", icon: <Heart className="w-4 h-4 text-pink-500" /> },
    { id: 5, title: "水を2リットル飲む", completed: false, category: "健康", icon: <Heart className="w-4 h-4 text-pink-500" /> }
  ]);
